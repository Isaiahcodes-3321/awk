...
import 'package:verzo/ui/views/create_customer/create_customer_view.form.dart';
...
class CreateCustomerView extends StackedView<CreateCustomerViewModel>
    with $CreateCustomerView {
  ...
  Widget builder(
    ...
    return Scaffold(
      ...
      body: AuthenticationLayout(
        ...
        subtitle: 'This helps you track who receives your products or services',
  ...
  @override
  void onDispose(CreateCustomerViewModel viewModel) {
    super.onDispose(viewModel);
    disposeForm();
  }

  @override
  void onViewModelReady(CreateCustomerViewModel viewModel) {
    syncFormWithViewModel(viewModel);
  }

  @override
  CreateCustomerViewModel viewModelBuilder(
    BuildContext context,
  ) =>
