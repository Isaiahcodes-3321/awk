...
import 'update_expense_viewmodel.dart';

class UpdateExpenseView extends StackedView<UpdateExpenseViewModel> {
  const UpdateExpenseView({Key? key}) : super(key: key);
        ...
        body: AuthenticationLayout(
          ...
          onMainButtonTapped: () {
            if (viewModel.formKey.currentState!.validate()) {
              viewModel.updateExpenseData(context);
            }
          },
          title: 'Update Expense',
          subtitle: 'Fill out the information below to edit this expense',
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField(
                  ...
                  value:
                      viewModel.updateExpenseCategoryIdController.text.isEmpty
                          ? null
                          : viewModel.updateExpenseCategoryIdController.text,
                  onChanged: (value) {
                    viewModel.updateExpenseCategoryIdController.text =
                        value.toString();
                  },
                ...
                TextFormField(
                  onTap: () async {
                    ...
                    if (viewModel.pickedDate != null) {
                      ...
                      viewModel.updateExpenseDateController.text =
                          formattedDate;
                    }
                  },
                  ...
                  decoration: InputDecoration(
                      ...
                      errorBorder: defaultErrorFormBorder),
                  style: ktsBodyText,
                  controller: viewModel.updateExpenseDateController,
                ...
                if (viewModel.expenseItems.isNotEmpty)
                  ListView.builder(
                    shrinkWrap: true,
                    itemCount: viewModel.expenseItems.length,
                    itemBuilder: (context, index) {
                      final expenseItem = viewModel.expenseItems[index];
  ...
  @override
  UpdateExpenseViewModel viewModelBuilder(
    BuildContext context,
  ) {
    final String expenseId =
        ModalRoute.of(context)!.settings.arguments as String;
    return UpdateExpenseViewModel(expenseId: expenseId);
  }
}
