...
import 'add_purchase_item_viewmodel.dart';
...
class AddPurchaseItemView extends StackedView<AddPurchaseItemViewModel>
    with $AddPurchaseItemView {
  const AddPurchaseItemView({Key? key}) : super(key: key);

  @override
  Widget builder(
    BuildContext context,
    AddPurchaseItemViewModel viewModel,
    Widget? child,
  ) {
    return Scaffold(
  ...
  @override
  void onDispose(AddPurchaseItemViewModel viewModel) {
    super.onDispose(viewModel);
    disposeForm();
  }

  @override
  void onViewModelReady(AddPurchaseItemViewModel viewModel) async {
    await viewModel.getProductUnits();
    syncFormWithViewModel(viewModel);
  }

  @override
  AddPurchaseItemViewModel viewModelBuilder(
    BuildContext context,
  ) =>
