...
import 'package:verzo/ui/views/make_sales_payment/make_sales_payment_viewmodel.dart';

@FormView(fields: [
  FormTextField(name: 'paymentDescription'),
  FormTextField(name: 'paymentTransactionDate'),
])
class MakeSalesPaymentView extends StackedView<MakeSalesPaymentViewModel>
    with $MakeSalesPaymentView {
  final Sales selectedSales;
  ...
  @override
  void onDispose(MakeSalesPaymentViewModel viewModel) {
    super.onDispose(viewModel);
    disposeForm();
  }

  @override
  MakeSalesPaymentViewModel viewModelBuilder(
    BuildContext context,
  ) {
    return MakeSalesPaymentViewModel(sale: selectedSales);
  }

  @override
  void onViewModelReady(MakeSalesPaymentViewModel viewModel) async {
  ...
  Widget builder(
    BuildContext context,
    MakeSalesPaymentViewModel viewModel,
    Widget? child,
  ) {
    return AuthenticationLayout(
        ...
        subtitle: 'Add payment to this sale',
