...
final Map<String, TextEditingController> _AddProductViewTextEditingControllers =
    {};

final Map<String, FocusNode> _AddProductViewFocusNodes = {};

final Map<String, String? Function(String?)?> _AddProductViewTextValidations = {
...
mixin $AddProductView {
  ...
  TextEditingController _getFormTextEditingController(
    ...
    if (_AddProductViewTextEditingControllers.containsKey(key)) {
      return _AddProductViewTextEditingControllers[key]!;
    }

    _AddProductViewTextEditingControllers[key] =
        TextEditingController(text: initialValue);
    return _AddProductViewTextEditingControllers[key]!;
  }

  FocusNode _getFormFocusNode(String key) {
    if (_AddProductViewFocusNodes.containsKey(key)) {
      return _AddProductViewFocusNodes[key]!;
    }
    _AddProductViewFocusNodes[key] = FocusNode();
    return _AddProductViewFocusNodes[key]!;
  }
  ...
  void disposeForm() {
    ...
    for (var controller in _AddProductViewTextEditingControllers.values) {
      controller.dispose();
    }
    for (var focusNode in _AddProductViewFocusNodes.values) {
      focusNode.dispose();
    }

    _AddProductViewTextEditingControllers.clear();
    _AddProductViewFocusNodes.clear();
  }
}
...
extension ValueProperties on FormStateHelper {
  ...
  set productNameValue(String? value) {
    ...
    if (_AddProductViewTextEditingControllers.containsKey(
        ProductNameValueKey)) {
      _AddProductViewTextEditingControllers[ProductNameValueKey]?.text =
          value ?? '';
    }
  }
  ...
  set priceValue(String? value) {
    ...
    if (_AddProductViewTextEditingControllers.containsKey(PriceValueKey)) {
      _AddProductViewTextEditingControllers[PriceValueKey]?.text = value ?? '';
    }
  }
  ...
  set initialStockLevelValue(String? value) {
    ...
    if (_AddProductViewTextEditingControllers.containsKey(
      ...
      _AddProductViewTextEditingControllers[InitialStockLevelValueKey]?.text =
          value ?? '';
    }
  }
  ...
  set productUnitIdValue(String? value) {
    ...
    if (_AddProductViewTextEditingControllers.containsKey(
      ...
      _AddProductViewTextEditingControllers[ProductUnitIdValueKey]?.text =
          value ?? '';
    }
  }
...
String? getValidationMessage(String key) {
  final validatorForKey = _AddProductViewTextValidations[key];
  if (validatorForKey == null) return null;

  String? validationMessageForKey = validatorForKey(
    _AddProductViewTextEditingControllers[key]!.text,
  );
