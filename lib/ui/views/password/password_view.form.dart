...
extension ValueProperties on FormStateHelper {
  ...
  set oldPasswordValue(String? value) {
    ...
    if (_PasswordViewTextEditingControllers.containsKey(OldPasswordValueKey)) {
      _PasswordViewTextEditingControllers[OldPasswordValueKey]?.text =
          value ?? '';
    }
  }
  ...
  set newPasswordValue(String? value) {
    ...
    if (_PasswordViewTextEditingControllers.containsKey(NewPasswordValueKey)) {
      _PasswordViewTextEditingControllers[NewPasswordValueKey]?.text =
          value ?? '';
    }
  }
