...
extension ValueProperties on FormStateHelper {
  ...
  set nameValue(String? value) {
    ...
    if (_CreateMerchantViewTextEditingControllers.containsKey(NameValueKey)) {
      _CreateMerchantViewTextEditingControllers[NameValueKey]?.text =
          value ?? '';
    }
  }
  ...
  set emailValue(String? value) {
    ...
    if (_CreateMerchantViewTextEditingControllers.containsKey(EmailValueKey)) {
      _CreateMerchantViewTextEditingControllers[EmailValueKey]?.text =
          value ?? '';
    }
  }
...
String? getValidationMessage(String key) {
  ...
  String? validationMessageForKey = validatorForKey(
    _CreateMerchantViewTextEditingControllers[key]!.text,
  );
